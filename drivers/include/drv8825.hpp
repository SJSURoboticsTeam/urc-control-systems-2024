...
private:
  ...
  long m_partial_steps = 0;  // total 1/32 steps taken from pos 0 (so reverse
                             // directions steps subtract)
  double m_partial_steps_to_deg = 1;
  step_factor m_step_factor = step_factor::one;
  drv8825(hal::output_pin& p_direction_pin,
...
public:
  static drv8825 create(hal::output_pin& p_direction_pin,
