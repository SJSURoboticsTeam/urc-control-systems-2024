...
public:
  ...
  struct ctor_params
  {
    hal::v5::strong_ptr<hal::output_pin> direction_pin;
    ...
    std::array<hal::v5::optional_ptr<hal::output_pin>, 3> mode_pins;
  };
...
private:
  hal::v5::strong_ptr<hal::output_pin> m_direction_pin;
  hal::v5::strong_ptr<hal::output_pin> m_step_pin;
  hal::v5::strong_ptr<hal::steady_clock> m_clock;
  hal::time_duration m_step_half_period;
  std::array<hal::v5::optional_ptr<hal::output_pin>, 3> m_mode_pins;
