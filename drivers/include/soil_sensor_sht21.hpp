...
{
public:
  static hal::byte const sht21_i2c_address = 0x40;

  /**
   * @brief Resolution settings. Used with `set_resolution`
   * rh_12bit_temp_14bit is 12 bits of resolution for relative humidity and 14
   * bit of resolution for temperature.
   */
  ...
  sht21(hal::v5::strong_ptr<hal::i2c> p_bus);
  ...
  /**
   * @brief Perform a single relative humidity measurement. This will block
