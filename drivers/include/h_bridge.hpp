...
{
public:
  explicit h_bridge(hal::v5::optional_ptr<hal::pwm16_channel> p_pin_a_high,
                    hal::v5::optional_ptr<hal::pwm16_channel> p_pin_b_high,
                    hal::v5::optional_ptr<hal::output_pin> p_pin_a_low,
                    hal::v5::optional_ptr<hal::output_pin> p_pin_b_low)
