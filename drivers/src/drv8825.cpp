...
drv8825::drv8825(hal::output_pin& p_direction_pin,
...
{
  return m_partial_steps * m_partial_steps_to_deg;
}

// can lose resolution
void drv8825::set_position(double position)
{
  m_partial_steps = position / m_partial_steps_to_deg;
}

void drv8825::driver_position(hal::degrees p_position)
{
  long partial_step_difference =
    p_position / m_partial_steps_to_deg - m_partial_steps;
  step(partial_step_difference * static_cast<int>(m_step_factor));
}

drv8825 drv8825::create(hal::output_pin& p_direction_pin,
                        ...
                        std::array<hal::output_pin&, 3> p_mode_pins)
{
  return drv8825(p_direction_pin,
                 p_step,
                 p_steady_clock,
                 p_step_factor,
                 p_steps_per_rotation,
                 p_mode_pins);
}