...
private:
  ...
  hal::actuator::rc_servo m_arm_servo;
  hal::actuator::rc_servo m_trap_door;
  hal::actuator::rc_servo m_mixer;
  hal::actuator::rc_servo m_door;
...
public:
  science_state_machine(hal::actuator::rc_servo p_arm_servo,
